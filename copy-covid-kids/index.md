---
layout: page
title: 'モントリオールでの隔離(Quarantine)について | Montreal academy club'
permalink: /copy-covid-kids/
source_url: https://www.montreal-academy.com/copy-covid-kids
---
...
![男は窓からの眺め](/assets/images/imported/--9671d1edb6b7.jpg)
...
入国審査、Work permitはトロントの空港で行いました。Arrive CanのReceiptの画面（下図）をみせて、POE letterをみせてWork permitを発行してもらい、間違いがないか確認しました。1時間ぐらいでした。Covid 19の検査はまだありませんでした。
...
2020/11/22 が隔離1日目になるのですが、そのAM5時ぐらいにメールが来てArrive Canが更新され、項目が入力できるようになりました。以後、Arrive CanはAM5時に更新されて、項目を入力するということを繰り返しました。電話は隔離1日目と7日目ごろに、私は来ました。元気か、ちゃんと隔離されているかといった内容でした。（下図参照）
...
![ArriveCAN.jpg](/assets/images/imported/--de03079993db.jpg)

![Day6.jpg](/assets/images/imported/--84064bab044b.jpg)
